...
function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F1E5] flex flex-col items-center px-5">
  ...
  <div className="flex flex-col items-center justify-center flex-1 w-full">
    ...
    >
      ...
      <img src={arrowIconWhite} alt="arrow" className="w-6 h-6 absolute right-4" />
    </button>

    <button
      onClick={() => navigate("/register")}
      className="mt-3 w-10/12 max-w-sm bg-[#2F5D34] text-white py-3 rounded-xl relative flex items-center justify-center"
    >
      <span className="text-center">Buat Akun</span>
      <img src={accountAddWhite} alt="account add" className="w-6 h-6 absolute right-4" />
    </button>
