function Landing() {
  return (
    <div className="min-h-screen bg-[#f4f1ed] flex flex-col items-center justify-center px-5">
      ...
      <button className="mt-6 w-full max-w-md bg-green-800 text-white py-3 rounded-full">
        Saya punya akun →
      </button>

      <button className="mt-3 w-full max-w-md bg-green-700 text-white py-3 rounded-full">
        Buat Akun +
      </button>
    </div>
  );
