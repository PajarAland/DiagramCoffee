  ...
  return (
    <div className="min-h-screen bg-[#F5F1E5] flex flex-col items-center justify-center px-5">
      ...
      <button
        ...
        className="mt-6 w-full max-w-md bg-[#2F5D34] text-white py-3 rounded-xl relative flex items-center justify-center"
      >
      ...
      <button
        ...
        className="mt-6 w-full max-w-10/12 bg-[#2F5D34] text-white py-3 rounded-xl relative flex items-center justify-center"
      >
