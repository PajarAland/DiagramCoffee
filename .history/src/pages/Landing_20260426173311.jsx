  ...
  return (
    <div className="min-h-screen bg-[#F5F1E5] flex flex-col items-center justify-center px-5">
      ...
      <button
        ...
        className="mt-6 w-full max-w-md bg-[#2F5D34] text-white py-3 rounded-xl flex items-center justify-between px-4"
      >
        <span>Saya punya akun</span>
        <img src={arrowIconWhite} alt="arrow" className="w-6 h-6" />
      </button>
